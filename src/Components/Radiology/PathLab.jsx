          ...
          <motion.aside variants={fadeInUp} className="w-full lg:col-span-1">
            <div className="bg-white rounded-2xl p-5 shadow-lg ring-1 ring-gray-100">
              <div className="flex items-center justify-between">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-sm text-green-500 font-medium">
                    Mon–Sat • 8am–6pm (Sample Collection)
                  </span>
                </div>
              </div>
              ...
              <div className="mt-4">
                <a
                  href="/contact"
                  className="w-full inline-flex items-center justify-center gap-3 px-4 py-3 rounded-lg text-white font-medium transition-colors hover:bg-[#349e65]"
                  style={{ background: COLORS.accent }}
                >
                  Book Your Test / Home Collection
                </a>
              </div>
