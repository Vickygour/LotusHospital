          ...
          <motion.aside variants={fadeInUp} className="w-full lg:w-auto">
            <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-lg ring-1 ring-gray-100 sticky top-4">
              ...
              <div className="mt-4">
                <a
                  href="/contact"
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 rounded-lg text-white font-medium text-sm sm:text-base hover:opacity-90 transition-opacity"
                  style={{ background: COLORS.accent }}
                >
                  Book Appointment
                </a>
